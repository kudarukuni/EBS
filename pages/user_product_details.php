                        ...
                        while($res = mysqli_fetch_array($result)){
                                    ...
                                    if (isset($_POST['submit'])){
                                        ...
                                        if(empty($prod_qty)){    
                                            ...
                                            if(empty($prod_qty)) {
                                            echo "<br><center><h4><font color='#a82f2f'><b>Sorry!</b> Out of Stock.</font></h4></center>";
                                        }
...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp; Back to index</a>
            <hr color="orange">
            <div class="col-md-12">
...
?>
        <?php }?> 
            ...
            <button class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#myModal">
                <i class="now-ui-icons shopping_cart-simple"></i>Add To Crates</button>
