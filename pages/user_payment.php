...
<body class="index-page sidebar-collapse">
    ...
    <?php
        ...
        $query = "INSERT INTO `order` (user_id, track_num, firstname, middlename, lastname, email, contact, shipping_add, order_date, `status`, totalprice, tax) VALUES ('$user_id','$track_num','$firstname','$middlename','$lastname','$email','$contact','$ship_add','$date','Pending','$total','$tax')";  
    ...
    ?>
        ...
        <hr color="orange"> 
        <br><br>
        <h3>If the payment type is <b>Cash On Delivery</b></h3>
        <h3>The delivery process time is between a minimum of three(3) working days and a maximum of five(5) working days.</h3><br>
        <h5>i-Bottle Store System &trade; &copy; &reg;. </h5>
