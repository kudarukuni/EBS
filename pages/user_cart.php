        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons shopping_basket"></i> &nbsp; Shop more items</a>
                      <hr color="orange"> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <input font color = "black" type="text" class="form-control" name="shipaddress" placeholder="Complete Address For Delivery Purpose." required/>
                      ...
                      <option value="Marange">Marange</option>
                      <option value="Plumtree">Plumtree</option>
                      <option value="Beichnough Bridge">Beichnough Bridge</option>
                      </select>  
                      </div>
