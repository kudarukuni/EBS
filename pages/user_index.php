    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Richard Gwewera." data-placement="bottom" target="">
                    i-Bottle Store
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Follow us on Twitter" data-placement="bottom" href="https://www.twitter.com/richardgwewera" target="_blank">
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/ironman.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        ...
                        <br><br>
                        <h3><font color="#1f0402">Absolut, Amarula, Archers, and Ancho Reyes</font></h3>
                    </div>
                </div>
            </div>
        </div>
                       ...
                       <center>
                        <label><b>Search Product: &nbsp;</b></label>       
                                <form method="POST" action="user_index_search.php" >
                                    ...
                                    <input type="text" name="search" class="search-query" placeholder="Search by name">
                                </form>
                        </center>
                    </div>
                    <br><hr color="orange">
            ...
            <div class="container">
                <nav>
                    <ul>
						...
						<li>Brought To You By <a href="#"> | i-Bottle Store &trade; </a> | BarWar Investments</li>
                    </ul>
                </nav>
                <div class="copyright">
                    &copy;
