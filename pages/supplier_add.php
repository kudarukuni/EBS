...
<head>
    ...
    <title>i-Bottle Store System</title>
...
<div class="panel panel-success panel-size-custom">
          <div class="panel-heading"><h3>Add Supplier</h3></div>
          ...
          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    ...
                    <input type="text" class="form-control" id="supp_contact" name="supp_contact" placeholder="+263772012345"/>
                    <label for="supp_email">Email:</label>
                    <input type="text" class="form-control" id="supp_email" name="supp_email" placeholder="richardgwewera@gmail.com"/>
                </div>
                <br>
